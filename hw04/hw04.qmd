...
The results can be found in [Problem 03-a Result](./hw04_03_a_results.html).
...
The result can be found in [Problem 03-b Result](./hw04_03_b_results.html).
...
The result can be found in [Problem 03-c Result](./hw04_03_c_results.html).
...
The result can be found in [Problem 03-d Result](./hw04_03_d_results.html).
...
The result can be found in [Problem 03-e Result](./hw04_03_e_results.html).
